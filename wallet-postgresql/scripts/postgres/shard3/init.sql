...
(3001, 3, 'COP', 3000000.00, 'ACTIVA'),
(3002, 6, 'USD', 850.00, 'ACTIVA'),
(3003, 9, 'COP', 760000.00, 'ACTIVA');

INSERT INTO movimientos (id_movimiento, id_cuenta, tipo_movimiento, monto, descripcion) VALUES
(7001, 3001, 'CREDITO', 3000000.00, 'Saldo inicial'),
(7002, 3002, 'CREDITO', 850.00, 'Saldo inicial'),
(7003, 3003, 'CREDITO', 760000.00, 'Saldo inicial');